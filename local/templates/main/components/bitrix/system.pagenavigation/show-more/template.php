...
<?if ($arResult["bShowAll"]):?>
    ...
    <?/*
    <a class="btn btn--empty" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>SHOWALL_<?=$arResult["NavNum"]?>=0" rel="nofollow"><?=GetMessage("nav_paged")?></a>
    */?>
    <?else:?>
    <a class="btn btn--empty" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>SHOWALL_<?=$arResult["NavNum"]?>=1" rel="nofollow">
        <?/*=GetMessage("nav_all")*/?>
        Загрузить ещё
    </a>
    <?endif?>
