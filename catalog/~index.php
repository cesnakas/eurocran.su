...
//$APPLICATION->SetTitle("Apeндa спецтехники Liebherr в ООО \"Компания ЕвроКран\"");
$APPLICATION->SetPageProperty("description", "«Компания Еврокран» предлагает недорогую аренду строительной спецтехники в Москве по выгодной цене. Поможем Вам реализовать строительные и грузоподъемные задачи без значительных финансовых трат");
