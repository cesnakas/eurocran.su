			...
			<div class="container--lg">
				<div class="projects__nav">
					<div class="projects__nav__item">
						<div class="projects__nav__box"><img src="<?=SITE_TEMPLATE_PATH?>/img/content/projects01.jpg"/>
						</div>
					</div>
					<div class="projects__nav__item">
						<div class="projects__nav__box"><img src="<?=SITE_TEMPLATE_PATH?>/img/content/projects01.jpg"/>
				...
				<div class="projects__slider">
					<div class="projects__slider__item">
						<div class="row">
							<div class="projects__slider__img"><img src="<?=SITE_TEMPLATE_PATH?>/img/content/projects1.jpg"/>
							</div>
							<div class="projects__slider__content">
								<h3>Монтаж вакуумных колонн LIEBHERR LR1300 и LIEBHERR LR1750</h3>
								<div class="projects__slider__location">Калужская обл.,Дзержинский район, пос. Полотняный завод</div>
								<p>Монтаж вакуумных колонн К-201 и К-2 «Техническое перевооружение установки АТ-101»  </p>
								<p>Монтаж произведен двумя гусеничными кранами LIEBHERR LR1300 и LIEBHERR LR1750.</p><a class="more" href="">Подробнее</a>
							</div>
						</div>
					</div>
					<div class="projects__slider__item">
			...
			<div class="catalog__slider" id="catalog__slider">
				<div class="catalog__item">
					<div class="catalog__row">
						<div class="catalog__img" style="background-image:url(<?=SITE_TEMPLATE_PATH?>/img/content/catalog1.jpg)"></div>
						...
						<div class="catalog__info">
							...
							<div class="catalog__more">Все характеристики</div>
						</div>
