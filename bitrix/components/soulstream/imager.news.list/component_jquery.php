...
$Nflightbox = $arParams['IMAGER_INCLUDE_SCRIPT'] == 'Y' && in_array('nflightbox', $arScript) ? 'jquery.nflightbox-1.0.0.js' :'';

if($Jquery || $Fancybox || $Lightbox || $Highslide || $Balupton || $Nflightbox)
{
