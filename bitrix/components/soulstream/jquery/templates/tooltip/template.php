...
<div >
	<h1>jQuery Tooltip plugin <em>v1.3</em></h1>
	<p>This is a demo page. <a href="http://bassistance.de/jquery-plugins/jquery-plugin-tooltip/">Home page</a></p>
	<hr />
	<p>
<div id="main">
	<fieldset id="set1">
	...
	<fieldset>
		...
		<img id="tonus" src="/bitrix/components/soulstream/jquery/templates/tooltip/images/image.png" height="80" title="No delay. The src value is displayed below the title" />
		<h3>Code</h3>
...
$('#pretty').tooltip({
	...
	<fieldset>
		...
		<img id="map" src="/bitrix/components/soulstream/jquery/templates/tooltip/images/karte.png" width="345" height="312" border="0" usemap="#Landkarte">
		<map name="Landkarte">
