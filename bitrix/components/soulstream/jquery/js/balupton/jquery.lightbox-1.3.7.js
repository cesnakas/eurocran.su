...
{	// Create our Plugin function, with $ as the argument (we pass the jQuery object over later)
	...
	{	// Our LightboxClass definition
		...
		files: {
			compressed: {
				js: {
					lightbox:	'/bitrix/components/soulstream/jquery/js/balupton/jquery.lightbox-1.3.7.min.js',
					colorBlend:	'/bitrix/components/soulstream/jquery/js/balupton/jquery.color-1.0.0.min.js'
				},
				css: {
					lightbox:	'/bitrix/components/soulstream/jquery/js/balupton/jquery.lightbox-1.3.7.css'
				}
			},
			uncompressed: {
				js: {
					lightbox:	'/bitrix/components/soulstream/jquery/js/balupton/jquery.lightbox-1.3.7.js',
					colorBlend:	'/bitrix/components/soulstream/jquery/js/balupton/jquery.color-1.0.0.js'
				},
				css: {
					lightbox:	'/bitrix/components/soulstream/jquery/js/balupton/jquery.lightbox-1.3.7.css'
				}
			...
			images: {
				prev:		'/bitrix/components/soulstream/jquery/js/balupton/images/prev.gif',
				next:		'/bitrix/components/soulstream/jquery/js/balupton/images/next.gif',
				blank:		'/bitrix/components/soulstream/jquery/js/balupton/images/blank.gif',
				loading:	'/bitrix/components/soulstream/jquery/js/balupton/images/loading.gif'
			}
		},
