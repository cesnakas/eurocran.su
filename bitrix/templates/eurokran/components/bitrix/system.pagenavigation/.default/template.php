...
<?if($arResult["bDescPageNumbering"] === true):?>
	...
	<?while($arResult["nStartPage"] >= $arResult["nEndPage"]):?>
		...
		<?if ($arResult["nStartPage"] == $arResult["NavPageNomer"]):?>
			<li class="active"><a href="#" onClick="return false;"><?=$NavRecordGroupPrint?></a></li>
	...
	<?if ($arResult["NavPageNomer"] > 1):?>
		<div class="next-page"><a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>"><span>Следующая страница</span> &rarr;</a></div>
	<?endif?>
	</div>
